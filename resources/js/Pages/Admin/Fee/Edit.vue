...
const form = useForm({
    name: props.fee?.name || '',
    fee_type: props.fee?.fee_type || 'other',
    description: props.fee?.description || '',
    amount: props.fee?.amount || '',
    class_id: props.fee?.class_id || '',
    academic_year: props.fee?.academic_year || '',
    due_date: props.fee?.due_date || '',
    is_recurring: props.fee?.is_recurring || false,
    recurring_period: props.fee?.recurring_period || '',
    status: props.fee?.status || 'active',
});
