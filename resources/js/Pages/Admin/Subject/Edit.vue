...
<template>
    <App :title="title">
        <AdminPageWrapper
            title="Edit Subject"
            :subtitle="`Editing: ${subject?.name || 'Subject'}`"
            icon="fas fa-edit"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500/50 font-mono uppercase"
                        />
