...
const title = [{label: "Assessments", href: route("admin.assessments.index")}];
...
<template>
    <App :title="title">
        <AdminPageWrapper
            ...
            :subtitle="`Total: ${assessments?.total || 0} assessment records`"
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        >
                            ...
                            <td class="px-6 py-4">
                                <span class="text-gray-800 dark:text-gray-200">{{ assessment.created_by?.full_name || 'N/A' }}</span>
                            </td>
                            <td class="px-6 py-4">
                                <span :class="[
