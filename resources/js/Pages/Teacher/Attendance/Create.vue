...
const title = [
    ...
    {label: "Mark Attendance", href: route("teacher.attendances.create")}
];
...
const submit = () => {
    ...
    form.post(route('teacher.attendances.store'), {
        onSuccess: () => {
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 overflow-hidden">
                <div class="bg-gradient-to-r from-purple-500 to-pink-500 p-6">
                    ...
                    <p class="text-purple-100 mt-1">Record attendance for students in a class</p>
                </div>
