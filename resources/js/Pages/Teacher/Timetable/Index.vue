...
const title = [{label: "My Timetable", href: route("teacher.timetable.index")}];
...
const handleSearch = () => {
    router.get(route('teacher.timetable.index'), {
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md border border-gray-200 dark:border-gray-700 p-6">
                <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
                    <div>
                        ...
                        <p class="text-gray-500 dark:text-gray-400 mt-2">View your teaching schedule</p>
                    </div>
